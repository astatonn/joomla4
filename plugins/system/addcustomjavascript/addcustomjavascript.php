...
{	
	...
	function onBeforeCompileHead()
	{
		...
		// Custom Javascript 1.
		// **********************************************************************
		if (!empty($this->params->get('custom_javascript_file_path_1')))
		{
			$custom_javascript_file_mode_1 = $this->params->get('custom_javascript_file_mode_1');
			if (($app->isClient('site') && strcmp($custom_javascript_file_mode_1, 'front-end')==0) || ($app->isClient('administrator') && strcmp($custom_javascript_file_mode_1, 'back-end')==0) || strcmp($custom_javascript_file_mode_1, 'both')==0)
			{				
				$custom_javascript_file_path_1 = JPATH_ROOT.'/'.$this->params->get('custom_javascript_file_path_1');
				if (file_exists($custom_javascript_file_path_1)) 
				{
					ob_start();
		...
		// Custom Javascript 2.
		// **********************************************************************
		if (!empty($this->params->get('custom_javascript_file_path_2')))
		{
			$custom_javascript_file_mode_2 = $this->params->get('custom_javascript_file_mode_2');
			if (($app->isClient('site') && strcmp($custom_javascript_file_mode_2, 'front-end')==0) || ($app->isClient('administrator') && strcmp($custom_javascript_file_mode_2, 'back-end')==0) || strcmp($custom_javascript_file_mode_2, 'both')==0)
			{				
				$custom_javascript_file_path_2 = JPATH_ROOT.'/'.$this->params->get('custom_javascript_file_path_2');
				if (file_exists($custom_javascript_file_path_2)) 
				{
					ob_start();
		...
		// Custom Javascript 3.
		// **********************************************************************
		if (!empty($this->params->get('custom_javascript_file_path_3')))
		{
			$custom_javascript_file_mode_3 = $this->params->get('custom_javascript_file_mode_3');
			if (($app->isClient('site') && strcmp($custom_javascript_file_mode_3, 'front-end')==0) || ($app->isClient('administrator') && strcmp($custom_javascript_file_mode_3, 'back-end')==0) || strcmp($custom_javascript_file_mode_3, 'both')==0)
			{				
				$custom_javascript_file_path_3 = JPATH_ROOT.'/'.$this->params->get('custom_javascript_file_path_3');
				if (file_exists($custom_javascript_file_path_3)) 
				{
					ob_start();
