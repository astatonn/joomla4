...
?>">	
		...
		<?php if ($this->params->get('brand', 1)) : ?>
			<div class="grid-child">
				<div class="navbar-brand">
					...
					<div class="site-description1">
						<h6 class="eb"> Exército Brasileiro </h6>
						<h1 class="portal-title">1º Centro de Telemática de Área</h1>
						<span class="portal-description">Centro de Telemática Landell de Moura</span>						
                	</div>		
				</div>							
			</div> 			
		<?php endif; ?>		
	...
	<div class="site-grid site-grid-a">
	...
	<footer class="container-footer footer full-width">
		...
		<div class="logo">
		<span class="copyright">©2023 - 4º Centro de Telemática de Área	</span>
		</div>	
		<div class="autoriza">
		<span">Publicação autorizada pelo Boletim Interno do CMA Nr xxx, em xx xxx xxxx. </span>
		</div>		
	</footer>
	<?php endif; ?>		
